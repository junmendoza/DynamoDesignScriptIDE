...
namespace Dynamo.Graph.Nodes
{
    ...
    public class PortModel : ModelBase
    {
        ...
        public PortModel(PortType portType, NodeModel owner, PortData data, bool isPortUsable = true)
        {
            IsConnected = false;
            PortType = portType;
            Owner = owner;
    ...
    public class PortData
    {
        ...
        // Flags if the ouput port is associated with a variable that is tagged as OUT
