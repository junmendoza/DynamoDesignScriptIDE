...
namespace ProtoCore
{
    namespace CompileTime
    {
        public class Context
        {
            ...
            /// <summary>
            /// Set the target language to emit
            /// </summary>
            public TargetLanguage.Language EmitTargetLanguage { get; set; }
            public string EmitTargetLanguagePath { get; set; }
            ...
            public Context()
            {
                ...
                EmitTargetLanguage = TargetLanguage.Language.kNone;
                EmitTargetLanguagePath = string.Empty;
            }
