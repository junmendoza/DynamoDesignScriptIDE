...
namespace ProtoCore.AST.ImperativeAST
{
    ...
    public class LanguageBlockNode : ImperativeNode
    {
        public LanguageBlockNode()
        {
            ...
            Dependencies = new List<ImperativeNode>();
        }
        ...
        public LanguageBlockNode(LanguageBlockNode rhs) : base(rhs)
        {
            ...
            Dependencies = new List<ImperativeNode>();
            foreach (ImperativeNode depNode in rhs.Dependencies)
            {
                ImperativeNode newNode = NodeUtils.Clone(depNode);
        ...
        public List<ImperativeNode> Dependencies { get; set; }
