...
namespace ProtoCore.AST.AssociativeAST
{
    ...
    public class CommentNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            return ToString();
        }
    ...
    public class LanguageBlockNode : AssociativeNode
    {
        public LanguageBlockNode()
        {
            ...
            Dependencies = new List<AssociativeNode>();
        }
        ...
        public LanguageBlockNode(LanguageBlockNode rhs) : base(rhs)
        {
            ...
            Dependencies = rhs.Dependencies.Select(NodeUtils.Clone).ToList();
        }
        ...
        public List<AssociativeNode> Dependencies { get; set; }
        ...
        public override string ToString()
        {
            ...
            {
                buf.Append("(");
                int dependencies = Dependencies.Count();
                for (int n = 0; n < dependencies; ++n)
                {
                    AssociativeNode depNode = Dependencies[n];
                    buf.Append(depNode.ToString());
                    if (n < dependencies - 1) {
                        buf.Append(",");
                    }
                }
        ...
        {
            var buf = new StringBuilder();
            buf.Append(CodeBlockNode.ToStringCPP());
            return buf.ToString();
        }
    ...
    public class TypedIdentifierNode : IdentifierNode
    {
        ...
        public override string ToString()
        {
            ...
            if (IsStatic) {
                staticType = ProtoCore.DSDefinitions.Keyword.Static;
            }
            return base.ToString() + " : " + staticType + datatype;
        }

        public override string ToStringCPP()
        {
            return ProtoCore.TargetLanguage.CPP.EmitCPP.EmitTypedIdentifier(this);
        }
    ...
    public class VarDeclNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            return ProtoCore.TargetLanguage.CPP.EmitCPP.EmitVarDeclaration(this);
        }
    ...
    public class ArgumentSignatureNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            ...
            for (int i = 0; i < Arguments.Count; ++i)
            {
                buf.Append(Arguments[i].ToStringCPP());
                if (i < Arguments.Count - 1)
                    buf.Append(", ");
            }
            return buf.ToString();
    ...
    public class FunctionDefinitionNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            return TargetLanguage.CPP.EmitCPP.EmitFunctionDefinition(this);
        }
    ...
    public class IfStatementNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            const string msg = "AST ToStringCPP Not supported";
            Validity.Assert(false, msg);
    ...
    public class BinaryExpressionNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            ...
            // If the right node is a language block node, then ignore the LHS.
            // In this case, just get the RHS string

            if (RightNode is LanguageBlockNode)
            {
                buf.Append(RightNode.ToStringCPP());
            }
            else
            {
                bool needBracket = LeftNode is BinaryExpressionNode || LeftNode is InlineConditionalNode || LeftNode is RangeExprNode;
                if (needBracket)
                    buf.Append("(");
                buf.Append(LeftNode.ToStringCPP());
                if (needBracket)
                    buf.Append(")");

                buf.Append(" ");
                if ((LeftNode is IdentifierNode) && (LeftNode as IdentifierNode).Name != ProtoCore.DSDefinitions.Keyword.Return) {
                    buf.Append(CoreUtils.GetOperatorString(Optr) + " ");
                }
    ...
    public class ImportNode : AssociativeNode
    {
        ...
        public override string ToStringCPP()
        {
            return ProtoCore.TargetLanguage.CPP.EmitCPP.EmitIncludeStmt(this);
        }
    ...
    public class AstFactory
    {
        ...
        public static VarDeclNode BuildVarDeclNode(string name, PrimitiveType type)
        {
            ProtoCore.Type varType = ProtoCore.TypeSystem.BuildPrimitiveTypeObject(type);

            VarDeclNode varDecl = new VarDeclNode();
            varDecl.Name = name;
            varDecl.ArgumentType = varType;

            IdentifierNode identNode = new IdentifierNode(name);
            varDecl.NameNode = identNode;
