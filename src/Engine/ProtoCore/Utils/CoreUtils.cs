...
namespace ProtoCore.Utils
{
    public static class CoreUtils
    {
        ...
        private static void InsertPredefinedMethod(Core core, CodeBlockNode root)
        {
            ...
            InsertBinaryOperationMethod(core, root, Operator.bitwiseand, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar);
            InsertBinaryOperationMethod(core, root, Operator.bitwisenegate, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar);
            InsertBinaryOperationMethod(core, root, Operator.bitwiseor, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar);
            InsertBinaryOperationMethod(core, root, Operator.bitwisexor, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar);
            InsertBinaryOperationMethod(core, root, Operator.shl, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar);
            InsertBinaryOperationMethod(core, root, Operator.shr, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar, PrimitiveType.kTypeVar);
        ...
        /// <summary>
        /// Check if the node is a single factor
        /// </summary>
        /// <param name="node"></param>
        /// <returns></returns>
        public static bool IsFactorASTNode(AssociativeNode node)
        {
            return IsPrimitiveASTNode(node)
                || node is TypedIdentifierNode
