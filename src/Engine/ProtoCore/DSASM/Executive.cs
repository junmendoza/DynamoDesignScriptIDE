...
{ 
    public class Executive : IExecutive
    {
        ...
        private void XOR_Handler(Instruction instruction)
        {
            StackValue opdata1 = rmem.Pop();
            StackValue opdata2 = rmem.Pop();
            ...
            if (opdata1.IsNumeric && opdata2.IsNumeric)
            {
                if (opdata1.IsDouble || opdata2.IsDouble)
                {
                    double lhs = opdata2.IsDouble ? opdata2.DoubleValue : opdata2.IntegerValue;
                    double rhs = opdata1.IsDouble ? opdata1.DoubleValue : opdata1.IntegerValue;
                    Validity.Assert(false, "XOR with double? Im not letting you! Use integers for both operands");
                }
                else
                {
                    opdata2 = StackValue.BuildInt(opdata2.IntegerValue ^ opdata1.IntegerValue);
        ...
        private void SHL_Handler(Instruction instruction)
        {
            StackValue opdata1 = rmem.Pop();
            StackValue opdata2 = rmem.Pop();
            ...
            if (opdata1.IsNumeric && opdata2.IsNumeric)
            {
                if (opdata1.IsDouble || opdata2.IsDouble)
                {
                    double lhs = opdata2.IsDouble ? opdata2.DoubleValue : opdata2.IntegerValue;
                    double rhs = opdata1.IsDouble ? opdata1.DoubleValue : opdata1.IntegerValue;
                    Validity.Assert(false, "Shift left with doubles? Im not letting you! Use integers for both operands");
                }
                else
                {
                    opdata2 = StackValue.BuildInt(opdata2.IntegerValue << (int)opdata1.IntegerValue);
                }
            }
            else
            {
        ...
        private void SHR_Handler(Instruction instruction)
        {
            StackValue opdata1 = rmem.Pop();
            StackValue opdata2 = rmem.Pop();
            ...
            if (opdata1.IsNumeric && opdata2.IsNumeric)
            {
                if (opdata1.IsDouble || opdata2.IsDouble)
                {
                    double lhs = opdata2.IsDouble ? opdata2.DoubleValue : opdata2.IntegerValue;
                    double rhs = opdata1.IsDouble ? opdata1.DoubleValue : opdata1.IntegerValue;
                    Validity.Assert(false, "Shift right with doubles? Im not letting you! Use integers for both operands");
                }
                else
                {
                    opdata2 = StackValue.BuildInt(opdata2.IntegerValue >> (int)opdata1.IntegerValue);
        ...
        private void BITAND_Handler(Instruction instruction)
        {
            ...
            if (opdata1.IsNumeric && opdata2.IsNumeric)
            {
                if (opdata1.IsDouble || opdata2.IsDouble)
                {
                    double lhs = opdata2.IsDouble ? opdata2.DoubleValue : opdata2.IntegerValue;
                    double rhs = opdata1.IsDouble ? opdata1.DoubleValue : opdata1.IntegerValue;
                    Validity.Assert(false, "BIT AND with doubles? Im not letting you! Use integers for both operands");
                }
                else
                {
                    opdata2 = StackValue.BuildInt(opdata2.IntegerValue & (int)opdata1.IntegerValue);
        ...
        private void BITOR_Handler(Instruction instruction)
        {
            ...
            if (opdata1.IsNumeric && opdata2.IsNumeric)
            {
                if (opdata1.IsDouble || opdata2.IsDouble)
                {
                    double lhs = opdata2.IsDouble ? opdata2.DoubleValue : opdata2.IntegerValue;
                    double rhs = opdata1.IsDouble ? opdata1.DoubleValue : opdata1.IntegerValue;
                    Validity.Assert(false, "BIT OR with doubles? Im not letting you! Use integers for both operands");
                }
                else
                {
                    opdata2 = StackValue.BuildInt(opdata2.IntegerValue | (int)opdata1.IntegerValue);
        ...
        private void Exec(Instruction instruction)
        {
            ...
            switch (instruction.opCode)
            {
                ...
                case OpCode.XOR:
                    {
                        XOR_Handler(instruction);
                        return;
                    }
                case OpCode.SHL:
                    {
                        SHL_Handler(instruction);
                        return;
                    }
                case OpCode.SHR:
                    {
                        SHR_Handler(instruction);
                        return;
                    }
                case OpCode.BITAND:
                    {
