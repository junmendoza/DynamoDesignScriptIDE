...
namespace ProtoCore.DSASM
{
    ...
    public struct kw
    {
        ...
        public const string bitwisenegate = "bitwisenegate";
    ...
    public class Op
    {
        ...
        private static void initOpNameTable()
        {
            ...
            opNameTable.Add(Operator.bitwiseand, ProtoCore.DSASM.kw.mod);
            opNameTable.Add(Operator.bitwisenegate, ProtoCore.DSASM.kw.mod);
            opNameTable.Add(Operator.bitwiseor, ProtoCore.DSASM.kw.mod);
            opNameTable.Add(Operator.bitwisexor, ProtoCore.DSASM.kw.mod);
            opNameTable.Add(Operator.shl, ProtoCore.DSASM.kw.mod);
            opNameTable.Add(Operator.shr, ProtoCore.DSASM.kw.mod);
        }
        ...
        private static void initOpCodeTable()
        {
            ...
            opCodeTable.Add(Operator.bitwisenegate, ProtoCore.DSASM.OpCode.NEG);
            opCodeTable.Add(Operator.bitwiseor, ProtoCore.DSASM.OpCode.BITOR);
            opCodeTable.Add(Operator.bitwisexor, ProtoCore.DSASM.OpCode.XOR);
            opCodeTable.Add(Operator.shl, ProtoCore.DSASM.OpCode.SHL);
            opCodeTable.Add(Operator.shr, ProtoCore.DSASM.OpCode.SHR);
        }
        ...
        private static void initOpSymbolTable()
        {
            ...
            opSymbolTable.Add(Operator.bitwisenegate, "~");
            opSymbolTable.Add(Operator.bitwiseor, "|");
            opSymbolTable.Add(Operator.bitwisexor, "^");
            opSymbolTable.Add(Operator.shl, "<<");
            opSymbolTable.Add(Operator.shr, ">>");
        }
