...
namespace ProtoScript.Runners
{
    ...
    public class ProtoScriptRunner
    {
        ...
        public bool CompileCPP(string code, out ParseResult parseResult)
        {
            ...
            // This is a flag to tell the parser to not compile predefines
            ...
            parseResult = ParserUtils.ParseWithCore(code, core);
