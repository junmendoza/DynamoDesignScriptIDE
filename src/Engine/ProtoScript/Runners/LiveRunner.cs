...
namespace ProtoScript.Runners
{
    ...
    public class ChangeSetData
    {
        ...
        public List<AssociativeNode> DeletedClassASTNodes;
        ...
        public List<AssociativeNode> RemovedClassDefNodesFromModification;
        public List<AssociativeNode> ForceExecuteASTList;
        public List<AssociativeNode> ModifiedFunctions;
        public List<AssociativeNode> ModifiedClasses;
    ...
    public class ChangeSetApplier
    {
        ...
        private void ApplyChangeSetDeleted(ChangeSetData changeSet)
        {
            ...
            UndefineClasses(changeSet.DeletedClassASTNodes);
        }
        ...
        private void ApplyChangeSetModified(ChangeSetData changeSet)
        {
            ...
            // Undefine a function that was removed 
            UndefineClasses(changeSet.RemovedClassDefNodesFromModification);
...
(runtimeCore, changeSet.ForceExecuteASTList);
        ...
        private void UndefineClasses(IEnumerable<AssociativeNode> classDeclList)
        {
            foreach (var classDecl in classDeclList)
            {
                core.SetClassInactive(classDecl as ClassDeclNode);
            }
        }
    ...
    public class ChangeSetComputer
    {
        ...
        public ChangeSetComputer Clone()
        {
            ...
            comp.csData.DeletedClassASTNodes = new List<AssociativeNode>(csData.DeletedClassASTNodes);
            ...
            comp.csData.RemovedClassDefNodesFromModification = new List<AssociativeNode>(csData.RemovedClassDefNodesFromModification);
            ...
            comp.csData.ModifiedClasses = new List<AssociativeNode>(csData.ModifiedClasses);
        ...
        private IEnumerable<AssociativeNode> GetDeltaAstListDeleted(IEnumerable<Subtree> deletedSubTrees)
        {
            ...
            csData.DeletedClassASTNodes = new List<AssociativeNode>();
                ...
                foreach (var st in deletedSubTrees)
                {
                    ...
                    if (currentSubTreeList.TryGetValue(st.GUID, out oldSubTree))
                    {
                        if (oldSubTree.AstNodes != null)
                        {
                            ...
                            csData.DeletedClassASTNodes.AddRange(oldSubTree.AstNodes.Where(n => n is ClassDeclNode));
                        }
        ...
        private void UpdateCachedASTList(Subtree st, List<AssociativeNode> modifiedASTList)
        {
            ...
            var modifiedClasses = modifiedASTList.Where(n => n is ClassDeclNode);
            csData.ModifiedClasses.AddRange(modifiedClasses);
            ...
            else
            {
                ...
                else
                {
                    ...
                    IEnumerable<AssociativeNode> removedClasses = oldSubTree.AstNodes.Where(f => f is ClassDeclNode && !st.AstNodes.Contains(f));
                    csData.RemovedClassDefNodesFromModification.AddRange(removedClasses);
        ...
        private IEnumerable<AssociativeNode> GetDeltaAstListModified(List<Subtree> modifiedSubTrees)
        {
            ...
            csData.RemovedClassDefNodesFromModification = new List<AssociativeNode>();
            csData.ModifiedClasses = new List<AssociativeNode>();
