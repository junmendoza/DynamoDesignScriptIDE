...
namespace Dynamo.ViewModels
{
    ...
    public partial class DynamoViewModel : ViewModelBase, IDynamoViewModel
    {
        ...
        public static DynamoViewModel Start(StartConfiguration startConfiguration = new StartConfiguration(), bool bgRender = true)
        {
            ...
            {
                startConfiguration.Watch3DViewModel = HelixWatch3DViewModel.TryCreateHelixWatch3DViewModel(bgRender,
